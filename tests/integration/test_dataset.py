...
def test_should_normalize():
    ...
    actual = dataset.normalize(normalize_columns, dataframe)
    expected = pd.DataFrame(
        [
            [137739, 51.5 / 269.8, 0.0 / 22.0, 13.0 / 32.0, 0.0 / 48.0, 2.0 / 39.0, 0.0 / 35.0],
            [31490, 173.4 / 269.8, 18.0 / 22.0, 0.0 / 32.0, 17.0 / 48.0, 22.0 / 39.0, 35.0 / 35.0],
            [112140, 269.8 / 269.8, 22.0 / 22.0, 32.0 / 32.0, 48.0 / 48.0, 39.0 / 39.0, 27.0 / 35.0]
        ],
        columns=[
            'id',
            'normalized_calories',
